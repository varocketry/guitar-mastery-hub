...
export default function PracticePage() {
  ...
  const lessonHint = lessonNumber ? getHintForLesson(lessonNumber) : null;
          ...
          <form onSubmit={handleSubmit} className="mb-8 bg-slate-50 rounded-lg p-6 space-y-6 border border-slate-200">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                rows={2}
                placeholder={getPlaceholderText('techniques', lessonNumber)}
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                rows={2}
                placeholder={getPlaceholderText('songs', lessonNumber)}
              />
            </div>
